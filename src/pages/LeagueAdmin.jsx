...
const s = {
  ...
  ligaLabel: { fontSize: 13, color: "#888", fontWeight: 600, flexShrink: 0 },
  ligaTabs: { display: "flex", gap: 8, flexWrap: "wrap" },
  ligaTab: { background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 20, padding: "7px 16px", color: "#888", fontSize: 13, cursor: "pointer", fontWeight: 500 },
  ligaTabActive: { background: "#1a2a1a", borderColor: GREEN, color: GREEN },
  ...
  equipoCard: { background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 14, padding: 20 },
  ...
  equipoNombre: { fontSize: 16, fontWeight: 700, color: "#fff", marginBottom: 6 },
  equipoMeta: { fontSize: 12, color: "#666", marginBottom: 14 },
  btnVer: { background: "transparent", border: "1px solid", borderRadius: 8, padding: "6px 14px", fontSize: 12, cursor: "pointer", fontWeight: 600 },
  detalleHeader: { background: SURFACE, borderRadius: 14, padding: "20px 24px", display: "flex", alignItems: "center", gap: 20, marginBottom: 24 },
  ...
  detalleNombre: { fontSize: 22, fontWeight: 800, color: "#fff", marginBottom: 4 },
  detalleMeta: { color: "#666", fontSize: 14 },
  jugadorList: { display: "flex", flexDirection: "column", gap: 10 },
  jugadorRow: { background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 12, padding: "14px 20px", display: "flex", alignItems: "center", gap: 16 },
  jugadorAvatar: { flexShrink: 0 },
  jugadorFoto: { width: 44, height: 44, borderRadius: "50%", objectFit: "cover" },
  jugadorFotoPlaceholder: { width: 44, height: 44, borderRadius: "50%", background: "#1e1e3a", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 20 },
  jugadorInfo: { flex: 1 },
  jugadorNombre: { fontSize: 15, fontWeight: 700, color: "#fff", marginBottom: 3 },
  jugadorMeta: { fontSize: 12, color: "#666" },
  ...
  dorsalLabel: { fontSize: 10, color: "#555" },
  jugadorCamiseta: { display: "flex", flexDirection: "column", alignItems: "center", gap: 4, minWidth: 80 },
  camisetaNombre: { fontSize: 13, fontWeight: 700, color: "#fff", textTransform: "uppercase" },
  camisetaLabel: { fontSize: 10, color: "#555" },
  ...
  emptyTxt: { color: "#666", fontSize: 15, marginBottom: 12 },
  ...
  modalBox: { background: "#13132a", border: `1px solid ${BORDER}`, borderRadius: 18, padding: 32, width: "100%", maxWidth: 440 },
  ...
  uploadLabel: { display: "inline-block", background: "#1e1e3a", border: `1px solid ${BORDER}`, borderRadius: 8, padding: "8px 14px", color: "#aaa", fontSize: 13, cursor: "pointer" },
  ...
  btnCancel: { flex: 1, background: "transparent", border: `1px solid ${BORDER}`, borderRadius: 10, padding: 12, color: "#888", fontSize: 14, cursor: "pointer" },
  btnSave: { flex: 2, background: GREEN, color: "#0d0d1a", border: "none", borderRadius: 10, padding: 12, fontWeight: 800, fontSize: 14, cursor: "pointer" },
  btnEdit: { background: "#1e1e3a", color: "#aaa", border: `1px solid ${BORDER}`, borderRadius: 7, padding: "5px 9px", fontSize: 13, cursor: "pointer" },
  btnDel: { background: "#2a1111", color: "#f87171", border: "1px solid #3a1a1a", borderRadius: 7, padding: "5px 9px", fontSize: 13, cursor: "pointer" },
...
const css = `
  ...
  .la-card:hover { transform: translateY(-2px); box-shadow: 0 6px 24px rgba(0,0,0,0.4); }
